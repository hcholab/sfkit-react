  ...
  const featuredWorkflows = [
    {
      ...
      description: "Identify genetic variants linked to diseases or health-related traits across multiple datasets",
    },
    {
      title: "Principal Component Analysis (PCA)",
      description: "Obtain a unified representation of genetic ancestry of individuals in multiple datasets",
    },
  ];
        ...
        <div className="row mt-3">
          ...
          <div className="col my-5">
            <div className="position-relative text-center rounded">
              <p className="lead">
                Try out our{" "}
                <Link className="text-decoration-none" to="/tutorial">
                  Tutorial
                </Link>{" "}
                to see <b>sfkit</b> in action
              </p>
            </div>
          </div>
          <div className="col my-5">
