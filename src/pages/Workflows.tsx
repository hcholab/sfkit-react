        ...
        <section className="py-5">
            <div className="container col-12 col-lg-6">
                ...
                <div className="bg-light p-4 mt-3 mx-auto">
                    ...
                    <p>
                        Secure computation refers to cryptographic techniques for analyzing encrypted private data without disclosing sensitive information. Our workflows use these methods to ensure that each dataset remains private throughout the collaborative study. We use both
                        <i> secure multiparty computation </i> (MPC) and
                        <i> homomorphic encryption </i> (HE) techniques in the design of our workflows to support a range of use cases.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        This workflow implements a secure and federated (SF) protocol for collaborative GWAS, meaning that each input dataset remains with the data holder and only a smaller amount of intermediate results are exchanged in an encrypted form. Unlike MPC-GWAS, even the encrypted input dataset is never shared to minimize the computational overhead. Our federated GWAS algorithm is introduced in <a className="text-decoration-none" href="https://www.nature.com/articles/s41467-021-25972-y" target="_blank" rel="noopener noreferrer">Truly Privacy-Preserving Federated Analytics for Precision Medicine with Multiparty Homomorphic Encryption</a> (Nature Communications, 2021). Further improvements and extensions in a recent <a className="text-decoration-none" href="https://www.biorxiv.org/content/10.1101/2022.11.30.518537v1" target="_blank" rel="noopener noreferrer">preprint</a> are also incorporated to provide the state-of-the-art performance. Similar to MPC-GWAS, this GWAS pipeline includes quality control filters, population stratification analysis, and association tests.
                    </p>

                    <p>
                        Each user provides an input dataset including genotypes, covariates, and a target phenotype for a local cohort of individuals. The joint analysis protocol makes an efficient use of local computation on the unencrypted data while ensuring that only encrypted intermediate results are shared among the users.
                    </p>
                </div>
